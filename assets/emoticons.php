...
<?php
		...
		function scut(){
			...
			echo "<div style=\"cursor:pointer;margin:2px\" onclick=\"loccoEmoticonsclink()\"><span id='loccoEmoticonslink'><strong>Afiseaza emoticoanele</strong></span>";
			if ( isset($opt['backlink']) && $opt['backlink'] ) echo "&nbsp;<a target=\"_blank\" href=\"http://locco.ro\">Locco.Ro</a>";
			else {
